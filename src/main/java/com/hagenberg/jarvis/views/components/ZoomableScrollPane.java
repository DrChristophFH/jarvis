...
/**
 * A ScrollPane which can zoom in and out.
 * <p>
 * The structure is as follows:
 * <ul>
 *     <li>ScrollPane</li>
 *     <ul>
 *         <li>Group (needed to facilitate independent positioning)</li>
 *         <ul>
 *             <li>Node (Content)</li>
 *         </ul>
 *    </ul>
 ...
 *
 * <p>
 * Based on a <a href="https://stackoverflow.com/questions/30679025/graph-visualisation-like-yfiles-in-javafx">Stack Overflow Comment from Roland</a>
 */
